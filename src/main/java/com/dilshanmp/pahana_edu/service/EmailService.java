...
public class EmailService {
    ...
    public void sendLowStockAlert(List<Item> items, String recipientEmail) throws MessagingException {
        ...
        message.setSubject("Low Stock Alert - Pahana Edu");
        ...
        content.append("<p>Please take necessary action to restock these items.</p>");
        content.append("<p>Best regards,<br>Pahana Edu System</p>");
    ...
    public void sendBillReceipt(Bill bill, byte[] pdfBytes) throws MessagingException {
        ...
        message.setSubject("Bill Receipt - " + bill.getBillNumber() + " - Pahana Edu");
    ...
    private String buildBillEmailContent(Bill bill) {
        ...
        content.append("</ul>");
        content.append("<p>The detailed bill is attached as a PDF document.</p>");
        content.append("<p>Thank you for choosing Pahana Edu!</p>");
        content.append("<p>Best regards,<br>Pahana Edu Team</p>");
        content.append("</body></html>");
    ...
    public void sendWelcomeEmail(Customer customer) throws MessagingException {
        ...
        message.setFrom(new InternetAddress(EMAIL_FROM));
        message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(customer.getEmail()));
        message.setSubject("Welcome to Pahana Edu!");
        ...
        String content = "<html><body>" +
                ...
                "<p>You can now enjoy our products and services. If you have any questions, please don't hesitate to contact us.</p>" +
